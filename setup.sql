...
CREATE TABLE IF NOT EXISTS public.ai_analytics (
    ...
    theme TEXT NOT NULL CHECK (theme IN ('Echo Chamber', 'Smart Shuffle Failure', 'Niche Genre Blending', 'UI/UX Clutter', 'Accurate Recommendations', 'Great UI/UX', 'Smart Curation', 'Positive')),
